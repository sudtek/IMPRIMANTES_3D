...
| Temperature extrudeurs°c |    235    |    205    | // Par defaut ces températures donneront un bon resultat mais il faudra toujours calibrer vos bobines.
...
** A la fin de l'impression Il est conseillé de faire baisser via un gcode la temperature progressivement par palier pour eviter le warping.


Mes observation : Jai rapidement pu consater que les objets imprimés avec ma QIDI IFAST à 1500€ etaient bien moins précis que sur ma vielle X1 300€ calibrée ... La  QIDI Ifast est une imprimante technique qui necesite imperativement une calibration complexe de bout en bout il est impossible de se contenter des réglages par defaut d'usine. J'ai donc decidé de consigner mes périgrinations, methodes, informations, gcode, profils ideamakers ... pour aider les autres utilisateurs qui possédent une QIDI IFAST à tirer le meilleur parti de leur machine. J'ai pris contact avec le support QIDI qui est réactif et amical mais qui reste selon moi trop supperficiel ... selon moi leurs produits ne sont pas sufisament doccumentés ... 

ATTENTION : Les gcodes de cette catégorie sont trés specifiques aux imprimantex QIDI IFAST !! Vous pouvez vous en inspirer mais si vous avez un autre modele il audra imperativement les adapter ! J'ai pour habitude de documenter afin que cela soit explicite néanmoins je vous recommande de toujours les relire et verifier avant de vou lancer.
